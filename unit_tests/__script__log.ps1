...
g++ log.cpp ../objects/record.obj ../objects/interval.obj ../objects/log.obj ../objects/order.obj ../objects/robot.obj ../objects/timestamp.obj ../objects/hash.obj ../objects/dim2.obj ../objects/item.obj ../objects/packing_station.obj
if($?)
{
  ./a.exe
  Remove-Item a.exe
