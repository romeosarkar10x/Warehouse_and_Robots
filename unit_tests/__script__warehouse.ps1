...
g++ warehouse.cpp ../objects/algorithm.obj ../objects/warehouse.obj ../objects/record.obj ../objects/interval.obj ../objects/log.obj ../objects/order.obj ../objects/robot.obj ../objects/timestamp.obj ../objects/hash.obj ../objects/dim2.obj ../objects/item.obj ../objects/packing_station.obj
if($?)
{
  ./a.exe > output.txt
}